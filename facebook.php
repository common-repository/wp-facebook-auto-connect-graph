...
class Facebook1
{
  ...
  public function getLoginUrl($params=array()) {
    ...
    return $this->getUrl(
      ...
      array_merge(array(
        ...
        'fbconnect'       => 1,
        //'next'            => $currentUrl,
        'next'            => plugins_url(dirname(plugin_basename(__FILE__))) . "/_process.php?action=login&return=$currentUrl&_wpnonce=".wp_create_nonce( $jfb_nonce_name ),
        'return_session'  => 1,
        'session_version' => 3,
        'v'               => '1.0',
      ), $params)
   ...
   */
  public function getLogoutUrl($logout_wp_url, $params=array()) {
    return $this->getUrl(
      'www',
      'logout.php',
      array_merge(array(
